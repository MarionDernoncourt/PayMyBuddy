...
public class TransactionControllerIT {
	...
	public void testGetUserTransactions() throws Exception {
		...
		TransactionDTO transaction = new TransactionDTO("description", BigDecimal.valueOf(100.0), "sender@gmail.com",
				"receiver@gmail.com");

		List<TransactionDTO> transactions = List.of(
				new TransactionDTO("description", BigDecimal.valueOf(100.0), "sender@gmail.com", "receiver@gmail.com"));
	...
	public void testGetUserTransactions_WithUnknownUser() throws Exception {
		...
		when(transactionService.getUserTransactions(username)).thenThrow(new IllegalArgumentException());
	...
	public void testGetUserTransactions_ShouldReturnSecurityException() throws Exception {
		...
		when(transactionService.getUserTransactions(username)).thenThrow(new SecurityException());
